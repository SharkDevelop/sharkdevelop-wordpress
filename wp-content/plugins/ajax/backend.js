	...
	this.init = function() {
		...
		**/
		...
		this.vars = {
			...
			enable_target_value_actions: ["set", "set_factor", "email_target", "set_min_selectable", "set_max_selectable", "add_class", "remove_class", "set_color", "select_option", "deselect_option", "show_option", "hide_option", "set_min", "set_max", "calc_routine_enable", "calc_routine_disable", "calc_routine_enable_name", "calc_routine_disable_name"],
			ezfc_elements_data         : [],
			form_options               : [],
			tooltips                   : [],
			ezfc_z_index               : 100001,
