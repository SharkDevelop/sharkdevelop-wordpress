...
function ezfc_get_global_settings() {
	...
	$settings = array(
		...
		__("Email", "ezfc") => array(
			...
			"email_smtp_enabled" => array("description" => __("Enable SMTP", "ezfc"), "description_long" => "", "type" => Ezfc_settings::$type_yesno),
			"email_smtp_anon"    => array("description" => __("Anonymous authentication", "ezfc"), "description_long" => __("If this option is enabled, the plugin will connect to the SMTP server anonymously.", "ezfc"), "type" => Ezfc_settings::$type_yesno, "default" => 0),
			"email_smtp_host"    => array("description" => __("SMTP Host", "ezfc"), "description_long" => "", "type" => Ezfc_settings::$type_input),
			"email_smtp_user"    => array("description" => __("SMTP Username", "ezfc"), "description_long" => "", "type" => Ezfc_settings::$type_input),
			"email_smtp_pass"    => array("description" => __("SMTP Password", "ezfc"), "description_long" => "", "type" => Ezfc_settings::$type_password),
			"email_smtp_port"    => array("description" => __("SMTP Port", "ezfc"), "description_long" => __("Default ports: 25 (no encryption), 465 (SSL), 587 (TLS).", "ezfc"), "type" => Ezfc_settings::$type_input),
			"email_smtp_secure"  => array("description" => __("SMTP Encryption", "ezfc"), "description_long" => "", "type" => Ezfc_settings::$type_dropdown, "options" => array(
				"0"   => __("No encryption", "ezfc"),
				"ssl" => "SSL",
				"tls" => "TLS" . " " . __("(recommended)", "ezfc")
			)),
			"email_smtp_debug_level"  => array("description" => __("SMTP Debug Level", "ezfc"), "description_long" => sprintf(__("Debug output level. If you're having problems connecting or sending emails through your SMTP server, you can increase the value to debug the issue. %s", "ezfc"), "<a href='https://github.com/PHPMailer/PHPMailer/wiki/SMTP-Debugging' target='_blank'>" . __("Debug levels", "ezfc") . "</a>"),  "type" => Ezfc_settings::$type_input, "default" => 0),
			"email_smtp_disable_verify_peer"  => array("description" => __("SMTP Disable Verify Peer", "ezfc"), "description_long" => __("Disables verify_peer and verify_peer_name and enables allow_self_signed. (Only change this if you know what you're doing)", "ezfc"), "type" => Ezfc_settings::$type_yesno),
		),

		__("PayPal", "ezfc") => array(
			"pp_api_username"         => array("description" => __("PayPal API username", "ezfc"), "description_long" => __("See <a href='https://developer.paypal.com/docs/classic/api/apiCredentials/'>PayPal docs</a> to read how to get your API credentials.", "ezfc"), "type" => Ezfc_settings::$type_input),
			"pp_api_password"         => array("description" => __("PayPal API password", "ezfc"), "description_long" => "", "type" => Ezfc_settings::$type_password),
			"pp_api_signature"        => array("description" => __("PayPal API signature", "ezfc"), "description_long" => "", "type" => Ezfc_settings::$type_input),
			"pp_return_url"           => array("description" => __("Return URL", "ezfc"), "description_long" => __("The return URL is the location where buyers return to when a payment has been succesfully authorized. <br>You need to use this shortcode on the return page/post or else it will not work:<br>[ezfc_verify]", "ezfc"), "type" => Ezfc_settings::$type_input),
			"pp_cancel_url"           => array("description" => __("Cancel URL", "ezfc"), "description_long" => __("The cancelURL is the location buyers are sent to when they hit the cancel button during authorization of payment during the PayPal flow.", "ezfc"), "type" => Ezfc_settings::$type_input),
			"pp_currency_code"        => array("description" => __("Currency code", "ezfc"), "description_long" => "", "type" => Ezfc_settings::$type_currencycodes),
			"pp_sandbox"              => array("description" => __("Use sandbox", "ezfc"), "description_long" => __("Set to 'yes' for testing purposes.", "ezfc"), "type" => Ezfc_settings::$type_yesno, "default" => 0),
			"pp_acount_required"      => array("description" => __("Account required", "ezfc"), "description_long" => __("Whether a PayPal account is required or not. If an account is optional, you still need to do the following step: Log in to your PayPal account, go to the Profile subtab, click on Website Payment Preferences under the Selling Preferences column, and check the yes/no box under PayPal Account Optional.", "ezfc"), "type" => Ezfc_settings::$type_yesno, "default" => 1)
		...
		__("Stripe", "ezfc") => array(
			"stripe_enabled" => array("description" => __("Enable Stripe", "ezfc"), "description_long" => "", "type" => Ezfc_settings::$type_yesno, "default" => 0),
			"stripe_currency_code" => array("description" => __("Currency code", "ezfc"), "description_long" => "", "type" => Ezfc_settings::$type_currencycodes),
			"stripe_secret_key" => array("description" => __("Secret key", "ezfc"), "description_long" => "", "type" => Ezfc_settings::$type_input),
			"stripe_publishable_key" => array("description" => __("Publishable key", "ezfc"), "description_long" => "", "type" => Ezfc_settings::$type_input)
		),
		...
		__("PDF", "ezfc") => array(
			...
			"pdf_text_company" => array("description" => __("PDF company text", "ezfc"), "description_long" => __("This text will be displayed in the company section in generated PDF files.", "ezfc"), "type" => Ezfc_settings::$type_editor, "default" => ""),
			"pdf_text_header" => array("description" => __("PDF header text", "ezfc"), "description_long" => __("This text will be displayed in the header section in generated PDF files.", "ezfc"), "type" => Ezfc_settings::$type_editor, "default" => ""),
			"pdf_text_footer" => array("description" => __("PDF footer text", "ezfc"), "description_long" => __("This text will be displayed in the footer section in generated PDF files.", "ezfc"), "type" => Ezfc_settings::$type_editor, "default" => ""),
		...
		__("ReCaptcha", "ezfc") => array(
			"captcha_public"  => array("description" => __("Recaptcha public key", "ezfc"), "description_long" => "", "type" => Ezfc_settings::$type_input),
			"captcha_private" => array("description" => __("Recaptcha private key", "ezfc"), "description_long" => "", "type" => Ezfc_settings::$type_input)
		),
		...
		"WooCommerce" => array(
			"woocommerce"            => array("description" => __("Integrate with WooCommerce", "ezfc"), "description_long" => __("Integrate with WooCommerce. Please be aware that on a single product page, the product price and add-to-cart button will be hidden since the plugin handles this.", "ezfc"), "type" => Ezfc_settings::$type_yesno),
			"woocommerce_text"       => array("description" => __("'Added to cart' text", "ezfc"), "description_long" => __("This text will be displayed after a submission was added to the cart.", "ezfc"), "type" => Ezfc_settings::$type_input, "default" => __("Added to cart", "ezfc")),
			"woocommerce_add_forms"  => array("description" => __("Add forms to products", "ezfc"), "description_long" => __("When this option is enabled, forms will be added to products automatically. If you want to show individual forms for products, please make sure you add a custom field to the product:<br>
				...
				More information here: <a href='http://ez-form-calculator.ezplugins.de/documentation/woocommerce-integration/' target='_blank'>ezfc Woocommerce Integration</a>", "ezfc"), "type" => Ezfc_settings::$type_yesno),
			"woocommerce_global_form_id"  => array("description" => __("Global form ID", "ezfc"), "description_long" => __("Form with this ID will be added to the WooCommerce product when 'Add forms to products' is set to 'Yes'", "ezfc"), "type" => Ezfc_settings::$type_input),
			"woocommerce_checkout_details" => array("description" => __("Show selected values in checkout", "ezfc"), "description_long" => __("Show the selected values in a table on the checkout page", "ezfc"), "type" => Ezfc_settings::$type_yesno, "default" => 1),
			"woocommerce_checkout_details_text" => array("description" => __("Checkout details text", "ezfc"), "description_long" => __("If 'Show selected values in checkout' is enabled, display this text above the details table.", "ezfc"), "type" => Ezfc_settings::$type_input, "default" => "Selected values"),
			...
			"woocommerce_enable_edit" => array("description" => __("Editable cart items", "ezfc"), "description_long" => __("Customers can edit the submitted form in the cart. When set to 'Yes', an editable link will be added to relevant cart items.", "ezfc"), "type" => Ezfc_settings::$type_yesno, "default" => 1),
			"woocommerce_edit_text" => array("description" => __("Edit text", "ezfc"), "description_long" => __("Text of the edit link.", "ezfc"), "type" => Ezfc_settings::$type_input, "default" => __("Edit", "ezfc")),
			"woocommerce_add_hook"  => array("description" => __("Form display hook", "ezfc"), "description_long" => sprintf(__("WooCommerce hook when forms are added to products (for a full list, see %s", "ezfc"), "<a href='https://docs.woocommerce.com/wc-apidocs/hook-docs.html' target='_blank'>docs.woothemes.com</a>)"), "type" => Ezfc_settings::$type_input, "default" => "woocommerce_before_add_to_cart_form"),
			"woocommerce_product_id" => array("description" => __("WooCommerce product id", "ezfc"), "description_long" => __("<strong>NOTE:</strong> this value is deprecated since v2.7.3 and has no effect - set the WooCommerce product id in the form options", "ezfc"), "type" => Ezfc_settings::$type_input),
			"woocommerce_update_cart" => array("description" => __("Update cart", "ezfc"), "description_long" => __("Update the mini-cart after adding products to the cart.", "ezfc"), "type" => Ezfc_settings::$type_yesno, "default" => 0),
			"woocommerce_update_cart_selector" => array("description" => __("Cart CSS selector", "ezfc"), "description_long" => __("The mini-cart CSS selector can change depending on your theme. If you are not sure, you might want to contact the theme author.", "ezfc") . $deprecated, "type" => Ezfc_settings::$type_input, "default" => ""),
			"woocommerce_update_cart_items_number_selector" => array("description" => __("Cart item number CSS selector", "ezfc"), "description_long" => __("Updates the cart item number after a product has been added to the cart. The cart item number CSS selector can change depending on your theme. If you are not sure, you might want to contact the theme author.", "ezfc") . $deprecated, "type" => Ezfc_settings::$type_input, "default" => ""),
			"woocommerce_insert_db" => array("description" => __("Insert form submissions on checkout", "ezfc"), "description_long" => __("Insert form submissions for each product that was added from the form on checkout.", "ezfc"), "type" => Ezfc_settings::$type_yesno, "default" => 0),
		...
		__("File upload", "ezfc") => array(
			"upload_override_filetypes" => array("description" => __("Override file types", "ezfc"), "description_long" => __("Override allowed default upload files types.", "ezfc"), "type" => Ezfc_settings::$type_yesno, "default" => 0),
			"upload_custom_filetypes" => array("description" => __("File types", "ezfc"), "description_long" => __("Allowed upload file types separated by comma.", "ezfc"), "type" => Ezfc_settings::$type_textarea, "default" => "gif,jpg,jpeg,png,pdf,doc,docx,csv,xls,xlsx,mp3,mp4,ogg,avi,zip"),
		),
		...
		"Zapier" => array(
			array("description" => __("Enable Zapier integration", "ezfc"), "description_long" => __("Turn Zapier integration on or off globally.", "ezfc"), "type" => Ezfc_settings::$type_yesno, "default" => 1)
		),
		...
		__("Other", "ezfc") => array(
			...
			"mailchimp_api_key"      => array("description" => __("Mailchimp API key", "ezfc"), "description_long" => "<a href='http://kb.mailchimp.com/accounts/management/about-api-keys'>" . __("How to find your API key", "ezfc") . "</a>", "type" => Ezfc_settings::$type_input),
